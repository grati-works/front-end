  ...
  return (
    <div className={styles.containerLogin}>
      <Head>
        ...
        <meta property='og:url' content='https://grati.works/auth/activate_account' />
        <meta property='og:type' content='website' />
      </Head>
      <AuthRoutesProvider pageName='Ativação de conta'>
        <div className={styles.inputs}>
          <Input Icon={Lock} placeholder='Senha Temporária' required password value={temporary_password} />
